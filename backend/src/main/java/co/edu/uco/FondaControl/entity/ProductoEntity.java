...
public final class ProductoEntity {
	...
	public void setPrecioLugar(final double precioLugar) {
		this.precioLugar = Math.max(0.0, precioLugar);
	}
	...
	public void setSubcategoria(final SubcategoriaEntity subcategoria) {
		this.subcategoria = UtilObjeto.getInstancia().obtenerValorDefecto(subcategoria,
				SubcategoriaEntity.obtenerValorDefecto());
	}
